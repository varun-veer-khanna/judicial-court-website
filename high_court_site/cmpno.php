  ...
  <div id="container" class="clear"> 
    ...
    <div id="content">
      <table summary="Summary Here" cellpadding="0" cellspacing="0">
        <thead>
          <tr>
            <th>Search Cases By Complaint Details</th>
            </tr>
        </thead>
      </table>
      ...
      <table border="2" height="200" cellspacing="10">
      	<tr>
            ...
            <th><input type="text" name="t2" required="required" class="textdata" /></th>
        </tr>    <tr>
        	<th>Complaint Date (DD/MM/YYYY)</th>
            <th><input type="date" name="t3" required="required" placeholder="DD/MM/YYYY" class="textdata" />
            </th>
        </tr>  
        <tr>
	...
	and cmpno='$b' and date='$c'")or die(mysql_error());
