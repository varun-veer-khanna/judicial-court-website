  ...
  <div id="container" class="clear"> 
    ...
    <div id="content">
      ...
      <table border="2" height="200" cellspacing="10">
        ...
        <tr>
        	<th width="30%">Registration Date From:(DD/MM/YYYY)</th>
            <th><input type="text" name="t2" /></th>
        </tr>
        <tr>
        	<th width="30%">Registration Date To:(DD/MM/YYYY)</th>
            <th><input type="text" name="t3" /></th>
        </tr>    <tr>
        	<th>Case Type</th>
            <th><select name='t4' class="text">
        ...
        <tr>
                	<th><h3>DISTRICT NAME</h3></th>
                	<th><select name='t6' class="text" >
        ...
        <input type="submit" value="Search Case" /></th></tr>
      </table>
      </form>
      <?php
	  if(isset($_POST['t1'])){
	...
	if(mysql_num_rows($r)>0){ 
      ...
      <table summary="Summary Here" cellpadding="0" cellspacing="0">
        <thead>
          <tr>
            <th colspan="5">Case Detail: Case Type:<?php echo $b ?>  
            Case No: <?php echo $a ?> 
            Case Year: <?php echo $c ?> </th>
            </tr>
           <tr>
           	<th>Case No</th>
