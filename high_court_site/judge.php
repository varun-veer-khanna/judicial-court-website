  ...
  <div id="container" class="clear"> 
    ...
    <div id="content">
      <table summary="Summary Here" cellpadding="0" cellspacing="0">
        <thead>
          <tr>
            <th>Judge Wise Judgment Search</th>
            </tr>
        </thead>
      </table>
      <form action="" method="post">
      <table border="2" height="400" cellspacing="10">
       <tr>
                	<th width="30%">From Date</th>
                	<th><input type="text" name="t1" 
                     required="required" class="textdata"></th>
                </tr>    
                <tr>
                	<th>To Date</th>
                	<th><input type="text" name="t2" required="required"  
                    class="textdata"></th>
                </tr>   
                  <tr>
                	<th>Select Judge</th>
                	<th>
                    	<select name="t3" class="textdata" required="required" style="width:450px;">
...
?>
                    ...
                    <tr>
        	<th>Party Name</th>
            <th><input type="text" name="t4" class="textdata" required="required"/></th>
        </tr>
                <tr>
                	<th>Case Type</th>
                	<th><select name='t5'class="textdata" style="width:450px;" required="required">
            	...
            	<tr>
                	<th>Case Year</th>
                	<th><select name="t6"class="textdata" style="width:450px;" required="required"> 
	  ...
	  if(isset($_POST['t1'])){
		...
		echo   $b=$_POST['t2'];
		  ...
		  $e=$_POST['t5'];
		  $f=$_POST['t6'];
	$r=mysql_query("select * from addcase where date='$a' 
	and final='$b' and judge='$c' and pname='$d' 
	and ctype='$e' and cyear='$f'")or die(mysql_error());
      ...
      <table summary="Summary Here" cellpadding="0" cellspacing="0">
        <thead>
          <tr>
            <th colspan="5">
    List of Judgments 
    Given By Hon'ble  between 
    
	<?php echo  $a ?> and <?php echo  $b ?>        
           </th>
            </tr>
           <tr>
           	<th>Case No</th>
